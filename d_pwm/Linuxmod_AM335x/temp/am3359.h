...
{ //  Pin        MUX_ADDR    MUX_DATA
	...
	{GP0_22,	CONTROL_PADCONF_GPMC_AD8,	(IEN | PU | MODE7)},
	{GP0_23,	CONTROL_PADCONF_GPMC_AD9,	(IEN | PU | MODE7)}, //dirA
	{GP0_26,	CONTROL_PADCONF_GPMC_AD10,	(IEN | PU | MODE7)},
	{GP0_27,	CONTROL_PADCONF_GPMC_AD11,	(IEN | PU | MODE7)},

	{GP1_0,		CONTROL_PADCONF_GPMC_CSN1,	(IDIS | PU | MODE7)}, //dira1
	{GP1_12,	CONTROL_PADCONF_GPMC_AD12,	(IDIS | PU | MODE7)}, //dira1
	{GP1_13,	CONTROL_PADCONF_GPMC_AD13,	(IDIS | PU | MODE7)}, //dira0
	{GP1_14,	CONTROL_PADCONF_GPMC_AD14,	(IDIS | PU | MODE7)}, //dirb1
	{GP1_15,	CONTROL_PADCONF_GPMC_AD15,	(IDIS | PU | MODE7)}, //dirb0
	{GP1_16,	CONTROL_PADCONF_GPMC_A0,	(IEN | PU | MODE7)},
	{GP1_17,	CONTROL_PADCONF_GPMC_A1,	(IEN | PU | MODE7)},	//intA
	{GP1_18,	CONTROL_PADCONF_GPMC_A2,	(IDIS | PD | MODE6)},	//ehrpwm1a
	{GP1_19,	CONTROL_PADCONF_GPMC_A3,	(IDIS | PD | MODE6)},	//ehrpwm1b
		
	{GP0_30,	CONTROL_PADCONF_GPMC_WAIT0,	(IEN | PU | MODE7)},
	{GP0_31,	CONTROL_PADCONF_GPMC_WPN,	(IEN | PU | MODE7)},
	{GP1_28,	CONTROL_PADCONF_GPMC_BEN1,	(IEN | PU | MODE7)},
	{GP1_29,	CONTROL_PADCONF_GPMC_CSN0,	(IEN | PU | MODE7)},
	
	{GP2_1,		CONTROL_PADCONF_GPMC_CLK,	(IEN | PU | MODE7)}, //dirB
	{GP2_2,		CONTROL_PADCONF_GPMC_ADVN_ALE,	(IEN | PU | MODE7)},
	{GP2_3,		CONTROL_PADCONF_GPMC_OEN_REN,	(IEN | PU | MODE7)},
	{GP2_4,		CONTROL_PADCONF_GPMC_WEN,	(IEN | PU | MODE7)},
	{GP2_5,		CONTROL_PADCONF_GPMC_BEN0_CLE,	(IEN | PU | MODE7)},

	{GP0_2,		CONTROL_PADCONF_SPI0_SCLK,	(IEN | PU | MODE7)},
	{GP0_3,		CONTROL_PADCONF_SPI0_D0,	(IEN | PU | MODE7)},
	{GP0_4,		CONTROL_PADCONF_SPI0_D1,	(IEN | PU | MODE7)},
	{GP0_5,		CONTROL_PADCONF_SPI0_CS0,	(IEN | PU | MODE7)},

	{GP0_14,	CONTROL_PADCONF_UART1_RXD,	(IEN | PU | MODE7)},
	{GP0_15,	CONTROL_PADCONF_UART1_TXD,	(IEN | PU | MODE7)},

	{GP3_14,	CONTROL_PADCONF_MCASP0_ACLKX,	(IDIS | PD | MODE1)},	//ehrpwm0a
	{GP3_15,	CONTROL_PADCONF_MCASP0_FSX,	(IDIS | PD | MODE1)},	//ehrpwm0b
	{GP3_16,	CONTROL_PADCONF_MCASP0_AXR0,	(IEN | PU | MODE7)},
	{GP3_17,	CONTROL_PADCONF_MCASP0_AHCLKR,	(IEN | PU | MODE7)},
	{GP3_19,	CONTROL_PADCONF_MCASP0_FSR,	(IEN | PU | MODE7)},
	{GP3_21,	CONTROL_PADCONF_MCASP0_AHCLKX,	(IEN | PU | MODE7)}, //intB
	{GP0_20,	CONTROL_PADCONF_XDMA_EVENT_INTR1,	(IEN | PU | MODE7)},
    	{-1 }
};
...
typedef struct
{
	...
	u32 *pGpio;   // GPIO bank base address
